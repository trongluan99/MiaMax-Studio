...
import com.ads.mia.funtion.AdmobHelper;
...
public class Admob {
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, AdmobAdCallback adListener) {
        isTimeDelay = false;
        isTimeout = false;
        ...
        getInterstitialAds(context, id, new AdmobAdCallback() {
            @Override
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, boolean showSplashIfReady, AdmobAdCallback adListener) {
        isTimeDelay = false;
        isTimeout = false;
    ...
    public void onShowSplash(AppCompatActivity activity, AdmobAdCallback adListener) {
        isShowLoadingSplash = true;
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            MiaLogEventManager.logPaidAdImpression(context,
                    adValue,
                    mInterstitialSplash.getAdUnitId(),
                    mInterstitialSplash.getResponseInfo()
                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
            if (tokenAdjust != null) {
                MiaLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
        });
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                MiaLogEventManager.logClickAdsEvent(context, mInterstitialSplash.getAdUnitId());
            }
    ...
    public void onShowSplash(AppCompatActivity activity, AdmobAdCallback adListener, InterstitialAd mInter) {
    ...
    public void getInterstitialAds(Context context, String id, AdmobAdCallback admobAdCallback) {
        if (AppPurchase.getInstance().isPurchased(context) || AdmobHelper.getNumClickAdsPerDay(context, id) >= maxClickAds) {
            admobAdCallback.onInterstitialLoad(null);
            return;
        }
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        if (admobAdCallback != null)
                            admobAdCallback.onInterstitialLoad(interstitialAd);
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            MiaLogEventManager.logPaidAdImpression(context,
                                    ...
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
    ...
    public void showInterstitialAdByTimes(final Context context, final InterstitialAd mInterstitialAd, final AdmobAdCallback callback, long timeDelay) {
        if (timeDelay > 0) {
            handlerTimeout = new Handler();
            rdTimeout = new Runnable() {
                @Override
    ...
    public void showInterstitialAdByTimes(final Context context, InterstitialAd mInterstitialAd, final AdmobAdCallback callback) {
        ...
        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                MiaLogEventManager.logClickAdsEvent(context, mInterstitialAd.getAdUnitId());
            }
        });
    ...
    public void forceShowInterstitial(Context context, InterstitialAd mInterstitialAd, final AdmobAdCallback callback) {
        currentClicked = numShowAds;
        showInterstitialAdByTimes(context, mInterstitialAd, callback);
    }

    private void showInterstitialAd(Context context, InterstitialAd mInterstitialAd, AdmobAdCallback callback) {
        currentClicked++;
    ...
    public void loadBanner(final Activity mActivity, String id, AdmobAdCallback callback) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
    ...
    @Deprecated
    public void loadBanner(final Activity mActivity, String id, final AdmobAdCallback callback, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        loadBanner(mActivity, id, adContainer, containerShimmer, callback, useInlineAdaptive, BANNER_INLINE_LARGE_STYLE);
    }

    public void loadInlineBanner(final Activity activity, String id, String inlineStyle, final AdmobAdCallback callback) {
        final FrameLayout adContainer = activity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = activity.findViewById(R.id.shimmer_container_banner);
        loadBanner(activity, id, adContainer, containerShimmer, callback, true, inlineStyle);
    }

    public void loadCollapsibleBanner(final Activity mActivity, String id, String gravity, final AdmobAdCallback callback) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        loadCollapsibleBanner(mActivity, id, gravity, adContainer, containerShimmer, callback);
    }

    public void loadCollapsibleBannerSizeMedium(final Activity mActivity, String id, String gravity, AdSize sizeBanner, final AdmobAdCallback callback) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
    ...
    public void loadBannerFragment(final Activity mActivity, String id, final View rootView, final AdmobAdCallback callback) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        loadBanner(mActivity, id, adContainer, containerShimmer, callback, false, BANNER_INLINE_LARGE_STYLE);
    }
    ...
    @Deprecated
    public void loadBannerFragment(final Activity mActivity, String id, final View rootView, final AdmobAdCallback callback, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        loadBanner(mActivity, id, adContainer, containerShimmer, callback, useInlineAdaptive, BANNER_INLINE_LARGE_STYLE);
    }

    public void loadInlineBannerFragment(final Activity activity, String id, final View rootView, String inlineStyle, final AdmobAdCallback callback) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        loadBanner(activity, id, adContainer, containerShimmer, callback, true, inlineStyle);
    }

    public void loadCollapsibleBannerFragment(final Activity mActivity, String id, final View rootView, String gravity, final AdmobAdCallback callback) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        loadCollapsibleBanner(mActivity, id, gravity, adContainer, containerShimmer, callback);
    }
    ...
    private void loadBanner(final Activity mActivity, String id,
                            ...
                            final AdmobAdCallback callback, Boolean useInlineAdaptive, String inlineStyle) {
        ...
        try {
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdLoaded() {
                    ...
                    if (adView != null) {
                        adView.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, adView.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
                ...
                public void onAdClicked() {
                    ...
                    MiaLogEventManager.logClickAdsEvent(context, id);
                }
    ...
    private void loadCollapsibleBanner(final Activity mActivity, String id, String gravity, final FrameLayout adContainer,
                                       final ShimmerFrameLayout containerShimmer, final AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(mActivity)) {
            containerShimmer.setVisibility(View.GONE);
            return;
        }
    ...
    private void loadInlineAdaptiveBanner(final Activity mActivity, String id, AdmobAdCallback admobAdCallback) {
    ...
    public void loadNativeAd(Context context, String id, final AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            return;
        }
        ...
        AdLoader adLoader = new AdLoader.Builder(context, id)
                .forNativeAd(nativeAd -> {
                    ...
                    nativeAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            MiaLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                        }
                    });
                })
    ...
    public void loadNativeAds(Context context, String id, final AdmobAdCallback callback, int countAd) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            callback.onAdClosed();
            return;
        }
    ...
    private void loadNative(final Context context, final ShimmerFrameLayout containerShimmer, final FrameLayout frameLayout, final String id, final int layout, final AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            containerShimmer.setVisibility(View.GONE);
            return;
        }
    ...
    public void loadNativeAdsFullScreen(Context context, String id, final AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            return;
        }
    ...
    public void loadNativeAdsFullScreen(final Context context, final ShimmerFrameLayout containerShimmer, final FrameLayout frameLayout, final String id, final int layout, final AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            containerShimmer.setVisibility(View.GONE);
            return;
        }
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    MiaLogEventManager.logPaidAdImpression(context,
                            ...
                            , AdType.REWARDED);
                    if (tokenAdjust != null) {
                        MiaLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
                });
            }
    ...
    public void initRewardAds(Context context, String id, AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            return;
        }
        this.nativeId = id;
    ...
    public void getRewardInterstitial(Context context, String id, AdmobAdCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            return;
        }
        this.nativeId = id;
    ...
    public void showRewardAds(final Activity context, final AdmobAdCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
    ...
    public void showRewardInterstitial(final Activity activity, RewardedInterstitialAd rewardedInterstitialAd, final AdmobAdCallback adCallback) {
        ...
        if (rewardedInterstitialAd == null) {
            ...
            rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    super.onAdClicked();
                    MiaLogEventManager.logClickAdsEvent(activity, rewardedAd.getAdUnitId());
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                }
            });
    ...
    public void showRewardAds(final Activity context, RewardedAd rewardedAd, final AdmobAdCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            adCallback.onUserEarnedReward(null);
            return;
        }
    ...
    public void loadInterSplashPriority4SameTime(final Context context,
        ...
        loadInterSplashHigh1(context, idAdsHigh1, timeOut, timeDelay, false, new AdmobAdCallback() {
            @Override
        ...
        loadInterSplashHigh2(context, idAdsHigh2, timeOut, timeDelay, new AdmobAdCallback() {
            @Override
            public void onAdSplashReady() {
                super.onAdSplashReady();
        ...
        loadInterSplashHigh3(context, idAdsHigh3, timeOut, timeDelay, new AdmobAdCallback() {
            @Override
            public void onAdSplashReady() {
                super.onAdSplashReady();
        ...
        loadInterSplashNormal(context, idAdsNormal, timeOut, timeDelay, new AdmobAdCallback() {
            @Override
            public void onAdSplashReady() {
                super.onAdSplashReady();
    ...
    public void onShowSplashPriority4(AppCompatActivity activity, AdmobAdCallback adListener) {
        isFailedPriority = false;
        if (mInterSplashHigh1 != null) {
            onShowSplashHigh1(activity, new AdmobAdCallback() {
                @Override
                ...
                public void onAdFailedToShow(@Nullable AdError adError) {
                    ...
                    onShowSplashHigh2(activity, new AdmobAdCallback() {
                        @Override
                        public void onAdClosed() {
                            super.onAdClosed();
                            adListener.onAdClosed();
                        ...
                        public void onAdFailedToShow(@Nullable AdError adError) {
                            ...
                            adListener.onAdPriorityFailedToShow(adError);
                            isFailedPriority = true;
                            onShowSplashHigh3(activity, new AdmobAdCallback() {
                                @Override
                                public void onAdClosed() {
                                    super.onAdClosed();
                                    adListener.onAdClosed();
                                ...
                                public void onAdFailedToShow(@Nullable AdError adError) {
                                    ...
                                    adListener.onAdPriorityFailedToShow(adError);
                                    isFailedPriority = true;
                                    onShowSplashNormal(activity, new AdmobAdCallback() {
                                        @Override
                                        public void onAdClosed() {
                                            super.onAdClosed();
                                            adListener.onAdClosed();
    ...
    private void loadInterSplashHigh1(final Context context, String id, long timeOut, long timeDelay, boolean showSplashIfReady, AdmobAdCallback adListener) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh1.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh1.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh1(AppCompatActivity activity, AdmobAdCallback adListener) {
        isShowLoadingSplash = true;
        if (mInterSplashHigh1 == null) {
            adListener.onNextAction();
            return;
        ...
        mInterSplashHigh1.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                MiaLogEventManager.logClickAdsEvent(context, mInterSplashHigh1.getAdUnitId());
            }
    ...
    private void loadInterSplashHigh2(final Context context, String id, long timeOut, long timeDelay, AdmobAdCallback adListener) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh2.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh2.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh2(AppCompatActivity activity, AdmobAdCallback adListener) {
        isShowLoadingSplash = true;
        if (mInterSplashHigh2 == null) {
            isShowLoadingSplash = false;
        ...
        mInterSplashHigh2.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                MiaLogEventManager.logClickAdsEvent(context, mInterSplashHigh2.getAdUnitId());
            }
    ...
    private void loadInterSplashHigh3(final Context context, String id, long timeOut, long timeDelay, AdmobAdCallback adListener) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh3.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh3.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh3(AppCompatActivity activity, AdmobAdCallback adListener) {
        isShowLoadingSplash = true;
        if (mInterSplashHigh3 == null) {
            isShowLoadingSplash = false;
        ...
        mInterSplashHigh3.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                MiaLogEventManager.logClickAdsEvent(context, mInterSplashHigh3.getAdUnitId());
            }
    ...
    private void loadInterSplashNormal(final Context context, String id, long timeOut, long timeDelay, AdmobAdCallback adListener) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashNormal.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                MiaLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashNormal.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    public void onShowSplashNormal(AppCompatActivity activity, AdmobAdCallback adListener) {
        isShowLoadingSplash = true;
        ...
        mInterSplashNormal.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                MiaLogEventManager.logClickAdsEvent(context, mInterSplashNormal.getAdUnitId());
            }
    ...
    public void onCheckShowSplashPriority4WhenFail(AppCompatActivity activity, AdmobAdCallback callback, int timeDelay) {
        new Handler(activity.getMainLooper()).postDelayed(() -> {
            if (!isShowLoadingSplash() && (mInterSplashHigh1 != null || mInterSplashHigh2 != null || mInterSplashHigh3 != null || mInterSplashNormal != null)) {
                onShowSplashPriority4(activity, new AdmobAdCallback() {
                    @Override
                    public void onAdClosed() {
                        super.onAdClosed();
