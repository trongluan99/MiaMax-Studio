package com.max.ads.mia.billing;
...
import com.max.ads.mia.funtion.BillingListener;
import com.max.ads.mia.funtion.PurchaseListener;
import com.max.ads.mia.funtion.UpdatePurchaseListener;
...
public class AppPurchase {
    ...
    private void handlePurchase(Purchase purchase) {
        ...
        MiaLogEventManager.onTrackRevenuePurchase((float) price, currency, idPurchaseCurrent, typeIap);
