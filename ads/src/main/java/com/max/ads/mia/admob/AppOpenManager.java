...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                MiaLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                        adValue,
                                        ad.getAdUnitId(),
                                        ad.getResponseInfo()
                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        MiaLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            MiaLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
    ...
    public void loadSplashOpenHighFloor(Class splashActivity, Activity activity, String idOpenHigh, String idOpenMedium, String idOpenAll, int timeOutOpen, AdmobAdCallback adListener) {
    ...
    public void loadSplashOpenAndInter(Class splashActivity, AppCompatActivity activity, String idOpen, String idInter, int timeOutOpen, AdmobAdCallback adListener) {
        isAppOpenShowed = false;
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            MiaLogEventManager.logPaidAdImpression(activity,
                                    adValue,
    ...
    public void loadAdOpenSplash2id(Class splashActivity, Activity activity, String idOpenHigh, String idOpenAll, int timeOutOpen, AdmobAdCallback adListener) {
        if (AppPurchase.getInstance().isPurchased(activity)) {
            if (adListener != null) {
                adListener.onNextAction();
            }
    ...
    public void onCheckShowAppOpenSplashWhenFail(AppCompatActivity activity, AdmobAdCallback callback, int timeDelay) {
    ...
    public void showAppOpenSplash(Context context, AdmobAdCallback adCallback) {
        if (splashAd == null) {
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            MiaLogEventManager.logClickAdsEvent(context, splashAdId);
    ...
    public void loadOpenAppAdSplash(final Context context, String idResumeSplash, final long timeDelay, long timeOut, final boolean isShowAdIfReady, final AdmobAdCallback adCallback) {
    ...
    public void loadOpenAppAdSplashFloor(final Context context, final List<String> listIDResume, final boolean isShowAdIfReady, final AdmobAdCallback adCallback) {
        if (!this.isNetworkConnected(context)) {
            (new Handler()).postDelayed(new Runnable() {
                public void run() {
                    adCallback.onAdFailedToLoad((LoadAdError) null);
    ...
    public void onCheckShowSplashWhenFail(final AppCompatActivity activity, final AdmobAdCallback callback, int timeDelay) {
    ...
    public void loadAndShowOpenSplash4SameTime(Context context, String idOpenHigh1, String idOpenHigh2, String idOpenHigh3, String idOpenNormal, long timeOut, AdmobAdCallback adCallback) {
        ...
        if (!this.isNetworkConnected(context)) {
            ...
            // Load Open High 1
            loadOpenHigh1(context, idOpenHigh1, timeOut, new AdmobAdCallback() {
                @Override
            ...
            loadOpenHigh2(context, idOpenHigh2, timeOut, new AdmobAdCallback() {
                @Override
                public void onAdSplashReady() {
                    super.onAdSplashReady();
                    if (isOpenHigh1Failed) {
            ...
            loadOpenHigh3(context, idOpenHigh3, timeOut, new AdmobAdCallback() {
                @Override
                public void onAdSplashReady() {
                    super.onAdSplashReady();
                    if (isOpenHigh1Failed && isOpenHigh2Loaded) {
            ...
            loadOpenNormal(context, idOpenNormal, timeOut, new AdmobAdCallback() {
                @Override
                public void onAdSplashReady() {
                    super.onAdSplashReady();
                    if (isOpenHigh1Failed && isOpenHigh2Loaded && isOpenHigh3Loaded) {
    ...
    public void showOpenSplash4SameTime(AppCompatActivity activity, AdmobAdCallback adListener) {
    ...
    private void loadOpenHigh1(Context context, String isOpenHigh1, long timeOut, AdmobAdCallback adCallback) {
    ...
    private void onShowSplashHigh1(AppCompatActivity activity, AdmobAdCallback adCallback) {
        if (mOpenSplashHigh1 == null) {
            adCallback.onNextAction();
            return;
        }
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh1.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            MiaLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh1.getAdUnitId());
                            adCallback.onAdClicked();
                        }
                    });
    ...
    private void loadOpenHigh2(Context context, String isOpenHigh2, long timeOut, AdmobAdCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            if (adCallback != null) {
                adCallback.onNextAction();
            }
    ...
    private void onShowSplashHigh2(AppCompatActivity activity, AdmobAdCallback adCallback) {
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh2.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            MiaLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh2.getAdUnitId());
                            adCallback.onAdClicked();
                        }
                    });
    ...
    private void loadOpenHigh3(Context context, String isOpenHigh3, long timeOut, AdmobAdCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            if (adCallback != null) {
                adCallback.onNextAction();
            }
    ...
    private void onShowSplashHigh3(AppCompatActivity activity, AdmobAdCallback adCallback) {
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh3.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            MiaLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh3.getAdUnitId());
                            adCallback.onAdClicked();
                        }
                    });
    ...
    private void loadOpenNormal(Context context, String isOpenNormal, long timeOut, AdmobAdCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context)) {
            if (adCallback != null) {
                adCallback.onNextAction();
            }
    ...
    private void onShowSplashNormal(AppCompatActivity activity, AdmobAdCallback adCallback) {
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashNormal.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            MiaLogEventManager.logClickAdsEvent(activity, mOpenSplashNormal.getAdUnitId());
                            adCallback.onAdClicked();
                        }
                    });
